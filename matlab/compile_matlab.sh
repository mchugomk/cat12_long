...
#     Matlab 2017b, including compiler, with license
#     Installation of SPM12, https://www.fil.ion.ucl.ac.uk/spm/software/spm12/
#
# The matlab version matters. If we compile with R2017b, it will only run under 
# the R2017b Runtime. More importantly, cat12 longitudinal batch seems only to
# work with R2017b.
#
...
SPM_PATH=/home/parallels/github/spm12 # /wkdir/external/spm12
